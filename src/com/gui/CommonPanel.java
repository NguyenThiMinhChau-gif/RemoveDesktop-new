...
public class CommonPanel extends JPanel {
    ...
    public CommonPanel() {
        ...
        this.setBorder(BorderFactory.createTitledBorder(null, "SERVER LISTENING",
            ...
            new Font("Ebrima", Font.BOLD, 18), Color.WHITE)
        );
        this.setBounds(50, 30, MainFrame.WIDTH_FRAME - 100, 320);
    ...
    private void initcomponents() {
        ...
        this.host_label.setBounds(50, 50, 120, 30);
        this.host_label.setFont(new Font("Ebrima", Font.BOLD, 15));
        this.host_label.setForeground(Color.WHITE);
        this.add(this.host_label);

        // TODO: style host_combo for server panel
        this.host_combo.setBounds(160, 50, 200, 25);
        this.add(this.host_combo);

        // TODO: style host_text for client panel
        this.host_text.setBounds(160, 50, 200, 25);
        this.host_text.setVisible(false);
        this.add(this.host_text);

        // TODO: style port_label
        this.port_label.setText("Server port:");
        this.port_label.setBounds(50, 80, 120, 30);
        this.port_label.setFont(new Font("Ebrima", Font.BOLD, 15));
        this.port_label.setForeground(Color.WHITE);
        this.add(this.port_label);

        // TODO: style port_text
        this.port_text.setBounds(160, 80, 200, 25);
        this.port_text.setText("9999");
        this.add(this.port_text);

        // TODO: style pass_label
        this.pass_label.setText("Set password:");
        this.pass_label.setBounds(50, 110, 120, 30);
        this.pass_label.setFont(new Font("Ebrima", Font.BOLD, 15));
        this.pass_label.setForeground(Color.WHITE);
        this.add(this.pass_label);

        // TODO: style pass_text for server panel
        this.pass_text.setBounds(160, 110, 200, 25);
        this.pass_text.setText("123456");
        this.add(this.pass_text);

        // TODO: style pass_field for client panel
        this.pass_field.setBounds(160, 110, 200, 25);
        ...
        this.help_label.setBounds(50, 150, 310, 120);
        this.help_label.setForeground(Color.CYAN /*decode(ClientPanel.FOREGROUND)*/);
        this.help_label.setFont(new Font("Ebrima", Font.PLAIN, 14));
