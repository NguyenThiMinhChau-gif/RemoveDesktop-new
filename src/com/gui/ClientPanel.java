...
public class ClientPanel extends JPanel {
    public final static String BACKGROUND = "0x4e5aaa";
    public final static String FOREGROUND = "0xfaaa5a";
    ...
    private void initComponents() {
        ...
        this.connect_label.setIcon(new ImageIcon(this.getClass().getClassLoader().getResource("data_transfer.png")));
        this.connect_label.setText(" CONNECT NOW");
        this.connect_label.setBounds(290, 380, 160, 30);
        this.connect_label.setForeground(Color.WHITE);
        this.connect_label.setFont(new Font("Ebrima", Font.PLAIN, 16));
        ...
        this.low_radio.setBounds(60, 360, 170, 30);
        this.low_radio.setForeground(Color.WHITE);
        this.low_radio.setFont(new Font("Ebrima", Font.PLAIN,16));
        ...
        this.high_radio.setBounds(60, 390, 170, 30);
        this.high_radio.setForeground(Color.WHITE);
        this.high_radio.setFont(new Font("Ebrima", Font.PLAIN,16));
