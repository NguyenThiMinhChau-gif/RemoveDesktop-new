...
public class FileLabel extends JLabel {
    ...
    public FileLabel(FileMessage file_message) {
        ...
        this.setFont(new Font("Ebrima", Font.ITALIC | Font.ITALIC, 14));
    ...
    private void fileLabelMouseEntered(MouseEvent e) {
        if(this.isEnabled()) {
            ...
            this.setFont(new Font("Ebrima", Font.ITALIC | Font.BOLD, 15));
        }
    }
    ...
    private void fileLabelMouseExited(MouseEvent e) {
        if(this.isEnabled()) {
            ...
            this.setFont(new Font("Ebrima", Font.ITALIC | Font.PLAIN, 14));
        }
    }
