...
public class ChatPanel extends JPanel implements Runnable {
    ...
    private void initComponents() {
        ...
        this.scroll_panel.setBounds(30, 10, MainFrame.WIDTH_FRAME - 60, MainFrame.HEIGHT_FRAME - 150);
        this.add(this.scroll_panel);

        // TODO: style message_text
        this.message_text.setFont(new Font("Ebrima", Font.PLAIN, 14));
        ...
        this.send_label.setForeground(Color.WHITE);
        this.send_label.setFont(new Font("Ebrima", Font.PLAIN, 14));
        ...
        this.file_label.setForeground(Color.WHITE);
        this.file_label.setFont(new Font("Ebrima", Font.PLAIN, 14));
